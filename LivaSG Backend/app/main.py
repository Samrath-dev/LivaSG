...
di_preference_repo=MemoryPreferenceRepo()
di_saved_location_repo=MemorySavedLocationRepo()
di_preference_service=PreferenceService(
    preference_repo=di_preference_repo,
    saved_location_repo=di_saved_location_repo,
    weights_repo=di_weights
)

app.dependency_overrides[preference_controller.get_preference_service] = lambda: di_preference_service
app.dependency_overrides[shortlist_controller.get_preference_service] = lambda: di_preference_service
